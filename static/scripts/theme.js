...
var toogletheme = document.getElementById('toogletheme');
...
var innerSearchBar = document.getElementById('innerSearchBar')
...
dark.addEventListener('click', () => {
    if (darkmode.style.color != 'white') {
        ...
        toogletheme.classList.add('toogletheme');
        toogletheme.classList.remove('darktheme');
        toogletheme.classList.remove('darkredtheme');
        ...
        innerSearchBar.style.backgroundColor = '#fafafa'
        chatbox.classList.remove('darkchatbox')
        chatbox.classList.add('chatbox')
        chatbox.classList.remove('darkRedchatbox')
        ...
        toogletheme.classList.remove('toogletheme');
        toogletheme.classList.add('darktheme');
        toogletheme.classList.remove('darkredtheme');
        close_theme.style.color = '#121212'
        ...
        innerSearchBar.style.backgroundColor = '#121212'
...
red_theme.addEventListener('click', () => {
    ...
    toogletheme.classList.remove('toogletheme');
    toogletheme.classList.remove('darktheme');
    toogletheme.classList.add('darkredtheme');
    chatbox.classList.remove('chatbox')
    chatbox.classList.remove('darkchatbox')
    chatbox.classList.add('darkRedchatbox')
    chatbot.style.color = '#fafafa'
    ...
    innerSearchBar.style.backgroundColor = 'darkred'
    innerSearchBar.style.color = '#fafafa'
